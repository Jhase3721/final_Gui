...
def main(page: ft.Page):
    ...
    # UI elements
    pin_input = ft.TextField(label="Enter 4-digit PIN", password=True, width=250, border_radius=10, border_color=ft.Colors.BLUE_700, focused_border_color=ft.Colors.BLUE_900, text_style=ft.TextStyle(size=16), hint_text="e.g., 1234")
    ...
    background_music = Audio(
        src="https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3",  # Replace with your music file or URL
        autoplay=False,  # We'll start it manually after adding to page
        volume=0.3,
        release_mode="LOOP"
    )
    ...
    # Call this after the initial page setup
    page.update()  # Ensure the page is updated before playing
